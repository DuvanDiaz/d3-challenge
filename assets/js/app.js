...
function makeResponsive() {
    ...
    // Axises assigned to the variable during an onclick event.
    // This variable is key to the ability to change axis/data column
    var currentAxisLabelX = "healthcare";
    var currentAxisLabelY = "income";
    ...
    var toolTip = d3
        ...
        if (currentAxisLabelX === "healthcare") {
            stringX = "Healthcare Avg: ";
            stringY = "Income Avg: ";
        }
        else if (currentAxisLabelX === "poverty") {
            stringX = "Poverty Avg: ";
            stringY = "Obesity Rate Avg: ";
        }
        else {
            stringX = "Age Avg: "
            stringY = "Smokers: ";
    ...
    d3.selectAll(".axis-text").on("click", function() {
        ...
        if (clickedAxis === "healthcare") {
            // x = corrAxis.attr(((d,i) => d.attr("id") === "income"));
            corrAxis = d3.select("#income");
        }
        else if (clickedAxis === "poverty") {
